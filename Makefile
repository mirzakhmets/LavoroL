...
src/lfs.o: src/lfs.cpp
	$(CPP) -c src/lfs.cpp -o src/lfs.o $(CXXFLAGS)

src/lfile.o: src/lfile.cpp
	$(CPP) -c src/lfile.cpp -o src/lfile.o $(CXXFLAGS)

src/lfont.o: src/lfont.cpp
	$(CPP) -c src/lfont.cpp -o src/lfont.o $(CXXFLAGS)

src/lscreen.o: src/lscreen.cpp
	$(CPP) -c src/lscreen.cpp -o src/lscreen.o $(CXXFLAGS)

src/ltask.o: src/ltask.cpp
	$(CPP) -c src/ltask.cpp -o src/ltask.o $(CXXFLAGS)

src/lsocket.o: src/lsocket.cpp
	$(CPP) -c src/lsocket.cpp -o src/lsocket.o $(CXXFLAGS)
